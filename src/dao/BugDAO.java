...
public interface BugDAO extends BaseDAO {
    ...
    /**
     * Returns the numbers of bugs (closed or opened) beetween dateFrom and
     * dateTo
     *
     * @param dateFrom Is the initial date.
     * @param dateTo Is the final date.
     * @param closed Indicates if status's bug is closed or not.
     * @return Int value
     */
