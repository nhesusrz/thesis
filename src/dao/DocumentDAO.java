...
public interface DocumentDAO extends BaseDAO {
    ...
    /**
     * Returns a list of documents in a version.
     *
     * @param versionId Version identificator.
     * @return List of documments DTO.
     */
    public List<BaseDTO> getDocsFromVersion(Integer versionId);

    /**
     * Reuturns a number of documments in a version.
     *
     * @param versionId Version identificator.
    ...
    /**
     * Executes the generation of documments for process with LDA.
     *
     * @return True if the process has success. False, if not.
     */
